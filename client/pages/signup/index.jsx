    ...
    <div className="loginPage py-6">
      <div className="max-w-[25rem] w-full mx-auto rounded-lg md:rounded-2xl p-4 md:p-8 shadow-input bg-slate-200">
        ...
        <div className="flex flex-col">
          <h1 className="text-[18px] text-gray-900 font-bold">Sign up</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div
            ...
            className="flex flex-row gap-1 items-center my-6 rounded-md py-3 px-4 border-[1px] border-gray-300 cursor-pointer"
          >
          ...
          <div className=" w-full mt-5">
            <input
              type="submit"
              value="Signup"
              className="rounded-lg hover:bg-blue-800 bg-blue-900 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex flex-row justify-center items-center py-3 px-6 cursor-pointer min-h-[45px] w-full text-[16px] font-Poppins font-semibold"
            />
          </div>
